...
import { StreamInstance } from "../entities/StreamInstance";
...
export const resolvers = {
  ...
  Mutation: {
    createExternalStream: async (root: any, args: any, ctx: IApolloContext, info: GraphQLResolveInfo) => {
      ...
      stream.avroSchema = args.avroSchema;
      ...
      if (!stream.batch) {
        ...
        stream.streamInstances = [streamInstance];
        stream.currentStreamInstance = streamInstance;
        await stream.save();
      }

/*
 * Fork of https://github.com/apple/foundationdb/tree/master/bindings/go/src/fdb/tuple
 * with FDB bindings removed
 * Highly recommend this blog post walking through how it works and why its good
...
// In Go these are represented as []byte, string, int64
...
//
// The valid types for TupleElement are []byte, string,
...
// string, int64, int, uint64, uint, *big.Int, big.Int, float32,

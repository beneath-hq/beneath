...
_READRECORDSRESPONSE.fields_by_name['records'].message_type = engine__pb2._RECORD
...
_GATEWAY = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    index=1,
    containing_service=None,
    input_type=engine__pb2._WRITERECORDSREQUEST,

              ...
              <Table>
                ...
                <TableBody>
                  <TableRow>
                    ...
                    <TableCell align="center">{prettyPrintBytes(billingPlan.baseReadQuota)}</TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell align="center" className={classes.tableKeyColumn}>Writes</TableCell>
                    <TableCell align="center">{prettyPrintBytes(billingPlan.baseWriteQuota)}</TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell align="center" className={classes.tableKeyColumn}>Scans</TableCell>
                    <TableCell align="center">{prettyPrintBytes(billingPlan.baseScanQuota)}</TableCell>
                  </TableRow>
                </TableBody>
              </Table>
            </>
